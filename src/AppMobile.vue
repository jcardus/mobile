  ...
  <f7-app :params="f7params">
    ...
    <f7-views tabs class="safe-areas">
      <f7-toolbar bottom labels tabbar>
        ...
        <f7-link v-if="!ios" tab-link="#view-dashboard" icon-ios="f7:dashboard" icon-aurora="f7:dashboard" icon-md="material:dashboard" :text="$t('route.dashboard')"></f7-link>
      </f7-toolbar>
      <f7-view id="view-map" main tab tab-active url="/map"></f7-view>
      <f7-view id="view-reports" name="reports" tab url="/reports"></f7-view>
      <f7-view v-if="!ios" id="view-dashboard" name="dashboard" url="/dashboard"></f7-view>
