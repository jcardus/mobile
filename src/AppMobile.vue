  ...
  <f7-app :params="f7params">
    ...
    <f7-views tabs class="safe-areas">
      <f7-toolbar :bottom="true" labels tabbar>
        ...
        <f7-link target="_blank" external :href="dashboardUrl" tab-link="#view-dashboard" icon-aurora="f7:dashboard" icon-ios="f7:rectangle_grid_2x2" icon-md="material:dashboard" :text="$t('route.dashboard')"></f7-link>
