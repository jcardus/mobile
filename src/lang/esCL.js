export default {
  ...
  map: {
    ...
    poi_create_name: 'Por favor indicar el nombre del PDI...',
  ...
  profile: {
    ...
    inactive_vehicles_email_tooltip: 'Será enviado un email de alarma indicando los equipos que no comunicam hace más de 48 horas',
  ...
  settings: {
    ...
    use_route_speed_limit: 'Usar límites de velocidad de la carretera',
    ...
    alert_delete_info: 'Desea eliminar la alarma de ',
    ...
    alert_add: 'Añadir Alarma',
    alert_edit: 'Editar Alarma',
    alert_delete: 'Eliminar Alarma',
    ...
    group_delete_info: 'Desea eliminar o grupo ',
    ...
    group_delete_not_allowed: 'No tienes permiso para eliminar grupos.',
    drivers: 'Conductores',
    driver_name: 'Nombre',
    driver_email: 'E-Mail',
    driver_phone: 'Movil',
    driver_add: 'Añadir conductor',
    driver_edit: 'Editar',
    driver_edit_title: 'Editar conductor',
    driver_delete: 'Eliminar',
    driver_uniqueId: 'RFID',
    driver_notes: 'Notas',
    driver_form_cancel: 'Cancelar',
    driver_form_confirm: 'Confirmar',
    driver_deleted: 'O Conductor foi apagado.',
    driver_delete_info: 'Pretende eliminar o conductor ',
    driver_delete_title: 'Eliminar conductor',
    ...
    driver_delete_not_allowed: 'No tienes permiso para eliminar conductors.',
    reports: 'Reportes',
    ...
    temporary_link_delete_info: 'Pretende eliminar o acesso temporário  ',
    temporary_link_delete_title: 'Eliminar Acesso Temporário'
  },
  geofence: {
    showGeofences: 'Mostrat Geocercas',
    geofence_name: 'Nombre',
    geofence_edit: 'Editar',
    geofence_delete: 'Eliminar',
    geofence_deleted: 'A geocerca ha sido apagada',
    geofence_delete_info: '¿Quieres eliminar geocerca ',
    geofence_delete_title: 'Eliminar Geocerca',
    ...
    poi_delete_info: 'Pretende eliminar o PDI ',
    poi_delete_title: 'Eliminar PDI',
    ...
    linegeofence_delete_info: 'Pretende eliminar o corredor ',
    linegeofence_delete_title: 'Eliminar Corredor',
